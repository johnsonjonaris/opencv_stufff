...
This is a complete Visual Studio Project developed using Visual Studio 2012 and OpenCV 2.4.10 under Windows 7.  It should work on different versions with a little work.

1. You should install OpenCV v2.4.10 on your system in somewhere like C:\   It will automatically create an "opencv" folder in this location.
